...
#=====================================================================================================
#=====================================================================================================
# SKETCHING FOR THE VARYING TEMPERATURE IN DEHYDROGENATION OF 'R' INTO 'P' & H2
#=====================================================================================================
#=====================================================================================================
...
def ppTEMP(T):
    ...
    filename_link_fomat1='/home/toyegoke/ENS_kinetics/Final-PES/plot_PES-1.csv'
    G_g1=PESdata(T,filename_link_fomat1,G_m,int_id,'X','R','RX','UX','HX','VX','PX','H2','P','TS1','TS2','TSR','TSP','TSH2')  # with ads/des TS
    ...
    filename_link_fomat2='/home/toyegoke/ENS_kinetics/Final-PES/plot_PES-2.csv'
    ...
    filename_link_fomat3='/home/toyegoke/ENS_kinetics/Final-PES/plot_PES-3.csv'
    G_g3=PESdata(T,filename_link_fomat3,G_m,int_id,'X','Rb','RbX','UbX','HX','VbX','PbX','H2','Pb','TS1b','TS2b','TSRb','TSPb','TSH2')  # with ads/des TS
    ...
    filename_link_fomat4='/home/toyegoke/ENS_kinetics/Final-PES/plot_PES-4.csv'
    G_g4=PESdata(T,filename_link_fomat4,G_m,int_id,'X','Rc','RcX','UcX','HX','VcX','PcX','H2','Pc','TS1c','TS2c','TSRc','TSPc','TSH2')  # with ads/des TS
    ...
    filename_link_fomat5='/home/toyegoke/ENS_kinetics/Final-PES/plot_PES-5.csv'
    G_g5=PESdata(T,filename_link_fomat5,G_m,int_id,'X','Rd','RdX','UdX','HX','VdX','PdX','H2','Pd','TS1d','TS2d','TSRd','TSPd','TSH2')  # with ads/des TS
        
    #============================================================

    return G_g1, G_g2, G_g3, G_g4, G_g5
...
#rtemp = [530,540,550,560,570] # 550K +- 20K

rtemp = [400,450,480,500,510,530,540,550,560,570,600] # 550K +- 20K
gg1=[]; gg2=[]; gg3=[]; gg4=[]; gg5=[]
allG=[gg1,gg2,gg3,gg4,gg5]
...
for i in range(ranT):
    ...
    T=rtemp[i]
    G_g1, G_g2, G_g3, G_g4, G_g5=ppTEMP(T)
...
for j in range(ranP):
    ...
    fig = plt.figure()
    ax = plt.subplot(111)
    ax.plot(allG[j][0],label='530K')
    ax.plot(allG[j][1],label='540K')
    ax.plot(allG[j][2],label='550K')
    ax.plot(allG[j][3],label='560K')
    ax.plot(allG[j][4],label='570K')
    plt.xlabel('Reaction Path$')
    plt.ylabel('Free Energy, $G / eV$')
    plt.title(titl[j]+' PES At Different Temperature')
    ax.legend()
    #plt.show()
    fig.savefig('/home/toyegoke/ENS_kinetics/Final-PES/'+titl[j]+'_plot_PES.png')

    fig = plt.figure()
    ay = plt.subplot(111)
    ay.plot(allG[j][0],label='400K')
    ay.plot(allG[j][1],label='450K')
    ay.plot(allG[j][2],label='480K')
    ay.plot(allG[j][3],label='500K')
    ay.plot(allG[j][4],label='530K')
    ay.plot(allG[j][5],label='540K')
    ay.plot(allG[j][6],label='550K')
    ay.plot(allG[j][7],label='560K')
    ay.plot(allG[j][8],label='570K')
    ay.plot(allG[j][9],label='600K')
    plt.xlabel('Reaction Path$')
    plt.ylabel('Free Energy, $G / eV$')
    plt.title(titl[j]+' PES At Different Temperature')
    ay.legend()
    #plt.show()
    fig.savefig('/home/toyegoke/ENS_kinetics/Final-PES/'+titl[j]+'_plot_PES-more.png')
