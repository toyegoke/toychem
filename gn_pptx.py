from gn_thermop import thermoppt, specie_index 
#from gn_thermop_copy import thermoppt 
from gn_thermop import adsTS_E 
from gn_thermop import PES, PESdata, PESdatab, PESdataHMF_h2o_DFF_Au, PESdataHMF_h2o_HMFCA_Au, PESdataHMF_no_h2o_DFF_Pd, PESdataHMF_no_h2o_HMFCA_Pd
import numpy as np
...
def ppt_hmf_au (T, filename_link_fomat, filename_link_fomat2):
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/hmf/hmf_4/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/hmf/hmf_4/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/dff/dff_1/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/dff/dff_1/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/hmfca/hmfca_5/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/hmfca/hmfca_5/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/ffca/ffca_5/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/ffca/ffca_5/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/fdca/fdca_5/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/fdca/fdca_5/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/o2/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/o2/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/h2o/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/gas_phase/h2o/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xhmf/par/ring/fcc/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xhmf/par/ring/fcc/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xdff/par/oxo/brid/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xdff/par/oxo/brid/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xhmfca/par/ring/brid/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xhmfca/par/ring/brid/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xffca/per/ring/brid/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xffca/per/ring/brid/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xfdca/per/ring/hcp/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xfdca/per/ring/hcp/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xo2/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xo2/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xh2o/xh2o/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xh2o/xh2o/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xo/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xo/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xoh/fcc/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Au-ads/xoh/fcc/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    G_g6=PESdataHMF_h2o_DFF_Au(T,filename_link_fomat2,G_m,int_id,'slab','hmf','o2g','xo2','xo','xhmf','xdff','xoh','xffca','xfdca','xh2o','fdca','h2o')  # with ads/des TS
    G_g7=PESdataHMF_h2o_HMFCA_Au(T,filename_link_fomat2,G_m,int_id,'slab','hmf','o2g','xo2','xo','xhmf','xhmfca','xoh','xffca','xfdca','xh2o','fdca','h2o')  # with ads/des TS
      
    fig = plt.figure()       # <=========
    plt.plot(G_g6,label= 'HMF Oxidation over Au via DFF route')
    plt.plot(G_g7,label= 'HMF Oxidation over Au via HMFCA route')
    plt.grid(b=True, which='major', color='#666666', linestyle='-')
    plt.xlabel('Reaction Path')
    plt.ylabel('Energy in eV')
    plt.xticks(rotation=90)
...
def ppt_hmf_pd (T, filename_link_fomat, filename_link_fomat2):
    ...
    print(specie_id, '  T(K)=', To)  # Au CATALYST
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/slab/Pd111/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/slab/Pd111/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XHMF
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xhmf/par/ring/top/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xhmf/par/ring/top/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XDFF
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xdff/par/ring/hcp/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xdff/par/ring/hcp/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XHMFCA
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xhmfca/per/ring/brid/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xhmfca/per/ring/brid/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XFFCA
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xffca/per/ring/fcc/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xffca/per/ring/fcc/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XFDCA
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xfdca/per/ring/fcc/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xfdca/per/ring/fcc/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XO2
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xo2/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xo2/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XH2O
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xh2o/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xh2o/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XO
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xo/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xo/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    print(specie_id, '  T(K)=', To)  # XOH
    int_id.append(specie_id)
    a="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xoh/OPT/FREQ/CONTCAR"
    b="/scratch/toyegoke/psmn_output/HMF_results/Pd-ads/xoh/OPT/FREQ/OUTCAR"
    [S, Cp, dH,  Q,  G, tetha_rot, tot_mmm, H, s_t, s_v, s_r, ZPE, E_elect, dH_t, dH_r, dH_v, q_t, q_r, q_v]=thermoppt(a,b,2,To,specie_id)
    S_m.append(S)
    s_v_m.append(s_v)
    dH_v_m.append(dH_v)
    ...
    G_g6=PESdataHMF_no_h2o_DFF_Pd(T,filename_link_fomat2,G_m,int_id,'slab','hmf','o2g','xo2','xo','xhmf','xdff','xoh','xffca','xfdca','xh2o','fdca','h2o')  # with ads/des TS
    G_g7=PESdataHMF_no_h2o_HMFCA_Pd(T,filename_link_fomat2,G_m,int_id,'slab','hmf','o2g','xo2','xo','xhmf','xhmfca','xoh','xffca','xfdca','xh2o','fdca','h2o')  # with ads/des TS
    fig = plt.figure()       # <=========
    plt.plot(G_g6,label= 'HMF Oxidation over Pd via DFF route')
    plt.plot(G_g7,label= 'HMF Oxidation over Pd via HMFCA route')
    plt.grid(b=True, which='major', color='#666666', linestyle='-')
    plt.xlabel('Reaction Path')
    plt.ylabel('Energy in eV')
    plt.xticks(rotation=90)
